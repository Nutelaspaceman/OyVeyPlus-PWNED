...
implements Util {
    ...
    public static boolean isInHole(EntityPlayerSP player) {
        ...
        return BlockUtil.isBlockAboveAHole(blockState, blockPos);
    }
    ...
    public static boolean isBlockAboveAHole(IBlockState blockState, BlockPos blockPos) {
        if (blockState.func_177230_c() != Blocks.field_150350_a) {
            return false;
        }
        if (BlockUtil.mc.field_71439_g.func_174818_b(blockPos) < 1.0) {
        ...
        return BlockUtil.isHole(blockPos);
    }
    ...
    public static boolean isHole(BlockPos blockPos) {
        for (BlockPos pos : BlockUtil.getTouchingBlocks(blockPos)) {
            IBlockState touchingState = BlockUtil.mc.field_71441_e.func_180495_p(pos);
            if (touchingState.func_177230_c() != Blocks.field_150350_a && (touchingState.func_177230_c() == Blocks.field_150357_h || touchingState.func_177230_c() == Blocks.field_150343_Z || touchingState.func_177230_c() == Blocks.field_150477_bB)) continue;
            return false;
        }
        return true;
    }
