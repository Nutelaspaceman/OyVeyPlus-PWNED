...
import me.earth.phobos.util.HoleFillUtil;
...
implements Util {
    ...
    public static void placeBlockScaffold(BlockPos pos) {
        ...
        for (EnumFacing side : EnumFacing.values()) {
            ...
            if (!BlockUtill.canBeClicked(neighbor)) continue;
    ...
    public static boolean canPlaceCrystal(BlockPos pos, boolean checkSecond) {
        Chunk chunk = BlockUtill.mc.field_71441_e.func_175726_f(pos);
        ...
        return BlockUtill.mc.field_71441_e.func_175647_a(Entity.class, new AxisAlignedBB((double)boost.func_177958_n(), (double)boost.func_177956_o(), (double)boost.func_177952_p(), (double)(boost.func_177958_n() + 1), (double)(boost.func_177956_o() + (checkSecond ? 2 : 1)), (double)(boost.func_177952_p() + 1)), e -> !(e instanceof EntityEnderCrystal)).isEmpty();
    }

    public static boolean isBlockEmpty(BlockPos pos) {
        try {
            if (emptyBlocks.contains((Object)BlockUtill.mc.field_71441_e.func_180495_p(pos).func_177230_c())) {
                Entity e;
                AxisAlignedBB box = new AxisAlignedBB(pos);
                Iterator entityIter = BlockUtill.mc.field_71441_e.field_72996_f.iterator();
                do {
    ...
    public static boolean canPlaceBlock(BlockPos pos) {
        if (BlockUtill.isBlockEmpty(pos)) {
            EnumFacing[] facings;
            for (EnumFacing f : facings = EnumFacing.values()) {
                if (emptyBlocks.contains((Object)BlockUtill.mc.field_71441_e.func_180495_p(pos.func_177972_a(f)).func_177230_c())) continue;
                ...
                if (!(BlockUtill.mc.field_71439_g.func_174824_e(mc.func_184121_ak()).func_72438_d(vec3d) <= 4.25)) continue;
                return true;
            }
        }
        return false;
    ...
    private static IBlockState getState(BlockPos pos) {
        return BlockUtill.mc.field_71441_e.func_180495_p(pos);
    }
    ...
    public static List<BlockPos> getSphere(float radius) {
        ...
        BlockPos pos = new BlockPos(BlockUtill.mc.field_71439_g.field_70165_t, BlockUtill.mc.field_71439_g.field_70163_u, BlockUtill.mc.field_71439_g.field_70161_v);
    ...
    public static Vec3d[] getOffsets(int y, boolean floor) {
        List<Vec3d> offsets = BlockUtill.getOffsetList(y, floor);
        Vec3d[] array = new Vec3d[offsets.size()];
        return offsets.toArray((T[])array);
    }

    public static boolean isSafe(Entity entity, int height, boolean floor) {
        return BlockUtill.getUnsafeBlocks(entity, height, floor).size() == 0;
    }

    public static List<Vec3d> getUnsafeBlocks(Entity entity, int height, boolean floor) {
        return BlockUtill.getUnsafeBlocksFromVec3d(entity.func_174791_d(), height, floor);
    }

    public static List<Vec3d> getUnsafeBlocksFromVec3d(Vec3d pos, int height, boolean floor) {
        ArrayList<Vec3d> vec3ds = new ArrayList<Vec3d>(5);
        for (Vec3d vector : BlockUtill.getOffsets(height, floor)) {
            Block block = BlockUtill.mc.field_71441_e.func_180495_p(new BlockPos(pos).func_177963_a(vector.field_72450_a, vector.field_72448_b, vector.field_72449_c)).func_177230_c();
    ...
    public static Vec3d[] getUnsafeBlockArray(Entity entity, int height, boolean floor) {
        List<Vec3d> list = BlockUtill.getUnsafeBlocks(entity, height, floor);
    ...
    public static void placeCrystalOnBlock(BlockPos pos, EnumHand hand, boolean swing) {
        RayTraceResult result = BlockUtill.mc.field_71441_e.func_72933_a(new Vec3d(BlockUtill.mc.field_71439_g.field_70165_t, BlockUtill.mc.field_71439_g.field_70163_u + (double)BlockUtill.mc.field_71439_g.func_70047_e(), BlockUtill.mc.field_71439_g.field_70161_v), new Vec3d((double)pos.func_177958_n() + 0.5, (double)pos.func_177956_o() - 0.5, (double)pos.func_177952_p() + 0.5));
        EnumFacing facing = result == null || result.field_178784_b == null ? EnumFacing.UP : result.field_178784_b;
        BlockUtill.mc.field_71439_g.field_71174_a.func_147297_a((Packet)new CPacketPlayerTryUseItemOnBlock(pos, facing, hand, 0.0f, 0.0f, 0.0f));
        if (swing) {
            BlockUtill.mc.field_71439_g.field_71174_a.func_147297_a((Packet)new CPacketAnimation(hand));
        }
    }
}
