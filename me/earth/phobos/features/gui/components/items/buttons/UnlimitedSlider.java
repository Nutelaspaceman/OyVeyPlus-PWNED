...
extends Button {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        Oyvey.textManager.drawStringWithShadow(" - " + this.setting.getName() + " \u00a77" + this.setting.getValue() + "\u00a7r +", this.x + 2.3f, this.y - 1.7f - (float)OyVeyGui.getClickGui().getTextOffset(), this.getState() ? -1 : -5592406);
    }
