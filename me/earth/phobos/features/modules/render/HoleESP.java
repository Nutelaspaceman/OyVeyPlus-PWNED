...
extends Module {
    ...
    public void onRender3D(Render3DEvent event) {
        ...
        for (BlockPos pos : Oyvey.holeManager.getSortedHoles()) {
            if (drawnHoles >= this.holes.getValue()) break;
            if (pos.equals((Object)new BlockPos(HoleESP.mc.field_71439_g.field_70165_t, HoleESP.mc.field_71439_g.field_70163_u, HoleESP.mc.field_71439_g.field_70161_v)) && !this.ownHole.getValue().booleanValue() || !RotationUtil.isInFov(pos)) continue;
            if (this.safeColor.getValue().booleanValue() && Oyvey.holeManager.isSafe(pos)) {
