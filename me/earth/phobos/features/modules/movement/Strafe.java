...
extends Module {
    ...
    public void onMove(MoveEvent event) {
        ...
        if (this.mode.getValue() == Mode.NCP) {
            ...
            if (this.limiter2.getValue().booleanValue() && Strafe.mc.field_71439_g.field_70122_E && Oyvey.speedManager.getSpeedKpH() < (double)this.speedLimit2.getValue().floatValue()) {
                this.stage = 2;
            }
            ...
            if (this.stage == 1 && EntityUtil.isMoving()) {
                ...
                if (Strafe.mc.field_71441_e.func_184144_a((Entity)Strafe.mc.field_71439_g, Strafe.mc.field_71439_g.func_174813_aQ().func_72317_d(0.0, Strafe.mc.field_71439_g.field_70181_x, 0.0)).size() > 0 || Strafe.mc.field_71439_g.field_70124_G && this.stage > 0) {
                    this.stage = this.bhop2.getValue() != false && Oyvey.speedManager.getSpeedKpH() >= (double)this.speedLimit.getValue().floatValue() ? 0 : (Strafe.mc.field_71439_g.field_191988_bg != 0.0f || Strafe.mc.field_71439_g.field_70702_br != 0.0f ? 1 : 0);
                }
    ...
    private boolean shouldReturn() {
        return Oyvey.moduleManager.isModuleEnabled(Freecam.class) || Oyvey.moduleManager.isModuleEnabled(Phase.class) || Oyvey.moduleManager.isModuleEnabled(Flight.class);
    }
